...
const WhoWeAre = () => {
    return (
        <section id="who-we-are" className="py-32 sm:py-48 bg-background relative overflow-hidden border-b border-primary/5">
            {/* Tech Accents */}
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-16 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-32 items-center">
                    ...
                    >
                        ...
                        <h2 className="font-heading font-black text-4xl sm:text-5xl lg:text-6xl xl:text-7xl text-text-main mb-10 tracking-tight leading-[0.9] uppercase">
                            ENGINEERING <br />
                            <span className="text-primary/30">WITH PURPOSE.</span>
                        </h2>
                    ...
                    >
                        <p className="font-body text-xl sm:text-2xl text-text-main/80 leading-relaxed font-light tracking-tight">
                        ...
                        <p className="font-body text-base text-text-muted leading-relaxed max-w-xl">
                        ...
                        <div className="grid grid-cols-2 gap-12 pt-12 border-t border-primary/5">
                            <div className="group">
                                <motion.div
                                    ...
                                    className="text-4xl sm:text-5xl font-heading font-black text-text-main mb-3 tracking-tighter group-hover:text-primary transition-colors duration-500"
                                >
                                    3+
                                </motion.div>
                                <div className="text-[0.6rem] font-bold text-text-muted uppercase tracking-[0.3em] leading-relaxed">
